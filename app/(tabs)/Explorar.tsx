...
export default function Explorar() {
  ...
  const [dados, setDados] = useState<typeof ongs>([]);
  const [modalVisible, setModalVisible] = useState(false);
  const [ongSelecionada, setOngSelecionada] = useState<typeof ongs[number] | null>(null);
  ...
  function abrirModal(ong: typeof ongs[number]) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>ONGs para você explorar</Text>
      <FlatList
        data={dados}
